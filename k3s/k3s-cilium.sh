#!/bin/bash
ufw disable
curl -sfL https://get.k3s.io | INSTALL_K3S_EXEC="server" sh -s - --disable-cloud-controller --disable=traefik --disable-network-policy --write-kubeconfig-mode=644 --disable-kube-proxy --flannel-backend none --token 123456
